...
describe('Bing Maps Geocoding Service', function () {
  ...
  before('init', () => {
    ...
    process.env.CONFIG = '{"apiKey": "ApY1DQW6gcWPJpXnQZoL8a6q0u-dPmg9oQvn3OZfMDij88z-Z1XUVJQAP9AaXjku", "geocodingType": "Forward"}'
  ...
  describe('#data', () => {
    it('should process the data and send back a result', function (done) {
      this.timeout(11000)
      let dummyData = { address: '178 Laurel Brook Rd, Middlefield, CT 06455' }
